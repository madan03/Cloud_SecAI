...
def main():
    ...
    input_file_path = base_dir / 'output/aws/prowler_results.csv'
    output_directory = base_dir / 'DataPre/output_pre'
    output_file_path = output_directory / 'prowler_aggregated_severity_counts.csv'
